import{importShared as e}from"./3d-tiles-renderer.Dzz-AO6s1776768216425.js";import{useTres as p,useLoop as x,OrbitControls_default as h}from"./index.DQMUb9Xb1776768216425.js";import{EffectComposer as g,RenderPass as _,ShaderPass as w}from"./RenderPass.xU3wjDte1776768216425.js";var y=`varying vec2 vUv;
void main(){
	vec4 mvPosition=modelViewMatrix*vec4(position,1.);
	gl_Position=projectionMatrix*mvPosition;
	vUv=uv;
}`,C=`uniform vec2 iResolution;
uniform float iTime;
varying vec2 vUv;
...
}`;const{defineComponent:k}=await e("vue"),{Vector2:P}=await e("three"),b=k({__name:"lightEffect",setup(d){const{camera:o,renderer:a,scene:n}=p(),{onBeforeRender:t}=x(),m={uniforms:{iResolution:{type:"v2",value:new P(window.innerWidth,window.innerHeight)},iTime:{type:"f",value:null},tDiffuse:{value:null}},vertexShader:y,fragmentShader:C},i=new g(a);i.addPass(new _(n.value,o.value));const l=new w(m);return i.addPass(l),t(({elapsed:f})=>{l.uniforms.iTime.value=f*.3,i.render()}),(f,L)=>null}}),{defineComponent:T}=await e("vue"),{createElementVNode:r,unref:z,createVNode:s,Suspense:R,withCtx:v,openBlock:u,createBlock:c,resolveComponent:S,mergeProps:D}=await e("vue"),V={ref:"perspectiveCameraRef",position:[600,750,-1221],fov:45,near:1,far:1e4},M=T({__name:"lightning",setup(d){const o={clearColor:"#000000",shadows:!0,alpha:!1,useLegacyLights:!0,renderMode:"manual"};return(a,n)=>{const t=S("TresCanvas");return u(),c(t,D(o,{"window-size":""}),{default:v(()=>[r("TresPerspectiveCamera",V,null,512),s(z(h)),n[0]||(n[0]=r("TresAmbientLight",{color:"#ffffff"},null,-1)),n[1]||(n[1]=r("TresDirectionalLight",{position:[400,400,400],intensity:1,color:"red"},null,-1)),(u(),c(R,null,{default:v(()=>[s(b)]),_:1}))]),_:1},16)}}});export{M as default};

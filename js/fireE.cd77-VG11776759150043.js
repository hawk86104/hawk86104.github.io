import{importShared as t}from"./3d-tiles-renderer.DGvROtvg1776759150043.js";import{_sfc_main as d}from"./pagesShow.vue_vue_type_script_setup_true_lang.Cs5LYx3t1776759150043.js";import{useTres as m,useLoop as f}from"./index.74ZWg8L31776759150043.js";const{defineComponent:p}=await t("vue"),{createElementVNode:a,normalizeProps:u,guardReactiveProps:h,openBlock:_,createElementBlock:P}=await t("vue"),{ref:x}=await t("vue"),o=await t("three"),y=`
varying vec2 vUv;
void main() {
vUv = uv;

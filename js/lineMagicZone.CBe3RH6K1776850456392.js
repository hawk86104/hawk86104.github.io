import{importShared as r}from"./3d-tiles-renderer.C6RRf79a1776850456392.js";import{Pane as B}from"./tweakpane.BQRZXf8M1776850456392.js";import{useLoop as M,customShaderMaterial_default as W,OrbitControls_default as E}from"./index.BLDmQRJv1776850456392.js";import{_sfc_main as D}from"./reflectorDUDV.vue_vue_type_script_setup_true_lang.BCcYSC9z1776850456392.js";import{useTexture$1 as O}from"./index.vue_vue_type_script_setup_true_lang.B11G9u621776850456392.js";import"./index.vue_vue_type_script_setup_true_lang.C9M2utMT1776850456392.js";const{withAsyncContext:k,defineComponent:A}=await r("vue"),{unref:m,createElementVNode:S,createVNode:L,openBlock:R,createElementBlock:V}=await r("vue"),$=["rotateX"],z=["position","aIndex","aNormal"],c=await r("three"),{useAttrs:H,watch:G}=await r("vue"),F=`
varying vec2 vMapUv;

import{importShared as r}from"./3d-tiles-renderer.BzwI5J1H1776680038358.js";import{useLoop as w,customShaderMaterial_default as T}from"./index.Dxn_Zjni1776680038358.js";import{buildRoundedPath as U}from"./buildFlexiblePipe.C2cvKh5G1776680038358.js";const{defineComponent:R}=await r("vue"),{createElementVNode:b,unref:G,createVNode:E,openBlock:L,createElementBlock:P}=await r("vue"),D={renderOrder:9999},B=["args"],{watch:f,ref:k}=await r("vue"),a=await r("three"),A=`
	varying vec2 vUv;
	void main() {
		vUv = vec3( uv, 1 ).xy; 
	}

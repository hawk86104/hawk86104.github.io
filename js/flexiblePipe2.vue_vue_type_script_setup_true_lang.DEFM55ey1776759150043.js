import{importShared as r}from"./3d-tiles-renderer.DGvROtvg1776759150043.js";import{useLoop as w,customShaderMaterial_default as T}from"./index.74ZWg8L31776759150043.js";import{buildRoundedPath as U}from"./buildFlexiblePipe.CmPxZ7GD1776759150043.js";const{defineComponent:R}=await r("vue"),{createElementVNode:b,unref:G,createVNode:E,openBlock:L,createElementBlock:P}=await r("vue"),D={renderOrder:9999},B=["args"],{watch:f,ref:k}=await r("vue"),a=await r("three"),A=`
	varying vec2 vUv;
	void main() {
		vUv = vec3( uv, 1 ).xy; 
	}

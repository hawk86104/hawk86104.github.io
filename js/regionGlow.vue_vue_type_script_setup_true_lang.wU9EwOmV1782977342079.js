import{importShared as n}from"./3d-tiles-renderer.XifnC2jl1782977342079.js";import{LineGeometry as h,Line2 as w}from"./Line2.N0spCSkx1782977342079.js";import{LineMaterial as _}from"./LineSegments2.DIh1s7GE1782977342079.js";import{resetUV as x}from"./utils.WD_PGOk01782977342079.js";const{defineComponent:M}=await n("vue"),{unref:v,createElementVNode:m,openBlock:y,createElementBlock:g}=await n("vue"),S=["object","rotation-x"],E=["object","rotation-x"],e=await n("three"),{watchEffect:U}=await n("vue"),j=M({__name:"regionGlow",props:{positionSrc:{default:[[0,0],[1,1]]},color:{default:"#ffff00"}},setup(p){const t=p,r=new e.Shape;t.positionSrc.forEach((o,s)=>{s===0?r.moveTo(o[0],o[1]):r.lineTo(o[0],o[1])});const a=new e.ShaderMaterial({vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;

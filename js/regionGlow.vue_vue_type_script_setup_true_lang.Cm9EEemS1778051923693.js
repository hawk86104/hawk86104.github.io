import{importShared as n}from"./3d-tiles-renderer.BJbxqKE81778051923693.js";import{LineGeometry as h,Line2 as w}from"./Line2.CzHgcw8Z1778051923693.js";import{LineMaterial as _}from"./LineSegments2.DEW1IVrC1778051923693.js";import{resetUV as x}from"./utils.DTR4DvA01778051923693.js";const{defineComponent:M}=await n("vue"),{unref:v,createElementVNode:m,openBlock:y,createElementBlock:g}=await n("vue"),S=["object","rotation-x"],E=["object","rotation-x"],e=await n("three"),{watchEffect:U}=await n("vue"),j=M({__name:"regionGlow",props:{positionSrc:{default:[[0,0],[1,1]]},color:{default:"#ffff00"}},setup(p){const t=p,r=new e.Shape;t.positionSrc.forEach((o,s)=>{s===0?r.moveTo(o[0],o[1]):r.lineTo(o[0],o[1])});const a=new e.ShaderMaterial({vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;

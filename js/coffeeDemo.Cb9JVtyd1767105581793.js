...
const _sfc_main$2 = /* @__PURE__ */ _defineComponent$2({
  __name: "firstLevel-42dee480409b",
  props: {
    object: {}
  },
  setup(__props) {
...
const _sfc_main$1 = /* @__PURE__ */ _defineComponent$1({
  ...
  async setup(__props) {
    ...
    const scene = ([__temp, __restore] = _withAsyncContext(() => loadJsonFile("./plugins/tresEditor/json/scene.json")), __temp = await __temp, __restore(), __temp);
    if (scene.geometries) {
        ...
        _createVNode(_unref(ol), _normalizeProps(_guardReactiveProps(state)), {
          default: _withCtx(() => [
            ...
            _createElementVNode("TresPerspectiveCamera", {
              ref_key: "cameraRef",
              ref: cameraRef,
              uuid: "3c19836b-b3b4-4d47-9a85-07c1c09e93e6",
              name: "Camera"
            }, null, 512),
...
//# sourceMappingURL=coffeeDemo.Cb9JVtyd1767105581793.js.map

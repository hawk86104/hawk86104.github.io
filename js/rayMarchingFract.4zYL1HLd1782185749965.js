import{importShared as e}from"./3d-tiles-renderer.DQlMUk2q1782185749965.js";import{useLoop as d,OrbitControls_default as v}from"./index.CpakLewG1782185749965.js";const _=`varying vec2 vUv;
void main(){
...
float sdBoxFrame(vec3 p,vec3 b,float e)
{
  ...
  return min(min(
    ...
    }`,{defineComponent:h}=await e("vue"),{createElementVNode:m,normalizeProps:g,guardReactiveProps:y,openBlock:q,createElementBlock:w}=await e("vue"),z=["rotation"],C={ref:"TresTubeGeometryRef",args:[1e3,1e3]},{DoubleSide:P,Vector2:i}=await e("three"),{watchEffect:b}=await e("vue"),B=h({__name:"rayMarchingMaterialFract",setup(u){const{onBeforeRender:a}=d(),t={transparent:!0,depthWrite:!0,depthTest:!0,side:P,vertexShader:_,fragmentShader:x,uniforms:{u_resolution:{value:new i(window.innerWidth,window.innerHeight)},u_mouse:{value:new i(0,0)},u_time:{value:0}}},l=window.innerWidth/2,n=window.innerHeight/2;let o=0,c=0;function f(r){o=r.clientX-l,c=r.clientY-n}return document.addEventListener("mousemove",f,!1),b(()=>{}),a(({elapsed:r})=>{t.uniforms.u_time.value+=.001,t.uniforms.u_mouse.value=new i(o,c)}),(r,N)=>(q(),w("TresMesh",{ref:"MeshRef",rotation:[Math.PI/2,0,0]},[m("TresPlaneGeometry",C,null,512),m("TresShaderMaterial",g(y(t)),null,16)],8,z))}}),{defineComponent:M}=await e("vue"),{createElementVNode:s,unref:T,normalizeProps:k,guardReactiveProps:D,createVNode:p,resolveComponent:E,mergeProps:R,withCtx:V,openBlock:F,createBlock:L}=await e("vue"),S={ref:"perspectiveCameraRef",position:[0,1500,0],fov:45,near:1,far:1e4},{onMounted:$}=await e("vue"),G=M({__name:"rayMarchingFract",setup(u){const a={clearColor:"#000000",shadows:!0,alpha:!1,useLegacyLights:!0},t={autoRotate:!1,enableDamping:!0};return $(()=>{}),(l,n)=>{const o=E("TresCanvas");return F(),L(o,R(a,{"window-size":""}),{default:V(()=>[s("TresPerspectiveCamera",S,null,512),p(T(v),k(D(t)),null,16),n[0]||(n[0]=s("TresAmbientLight",{color:"#ffffff"},null,-1)),n[1]||(n[1]=s("TresDirectionalLight",{position:[100,100,0],intensity:.5,color:"#ffffff"},null,-1)),p(B)]),_:1},16)}}});export{G as default};

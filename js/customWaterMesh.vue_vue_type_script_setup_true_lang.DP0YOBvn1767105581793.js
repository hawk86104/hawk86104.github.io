...
import { _sfc_main$11 as _sfc_main$1 } from './customShaderMaterial.vue_vue_type_script_setup_true_lang.rDMIDGqx1767105581793.js';
...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  __name: "customWaterMesh",
  props: {
    height: { default: 0.2 },
    Flatshading: { type: Boolean, default: false },
    waterColor: { default: "#52a7f7" },
    waterHighlight: { default: "#b3ffff" },
    brightness: { default: 1 },
    baseMaterial: { default: "MeshPhysicalMaterial" },
...
void main() {
  csm_DiffuseColor = vec4(calcColor(), 1.0);
    ...
    onBeforeRender(() => {
      uniforms.uTime.value -= 2e-3 * props.speed;
    });
    watchEffect(() => {
      uniforms.uHeight.value = props.height;
      uniforms.brightness.value = props.brightness;
      uniforms.waterColor.value.set(props.waterColor).convertLinearToSRGB();
      uniforms.waterHighlight.value.set(props.waterHighlight).convertLinearToSRGB();
    });
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("TresMesh", {
        ...
        _createElementVNode("TresBoxGeometry", {
          args: [5, 5, _ctx.height, 64, 64, 1]
        }, null, 8, _hoisted_2),
        _createVNode(_unref(_sfc_main$1), {
          baseMaterial: _ctx.baseMaterial,
          vertexShader: _unref(patchShaders)(shader.vertex),
          fragmentShader: shader.fragment,
          uniforms,
          side: THREE.DoubleSide,
          roughness: _ctx.roughness,
          metalness: _ctx.metalness,
          flatShading: _ctx.Flatshading,
          silent: ""
        }, null, 8, ["baseMaterial", "vertexShader", "fragmentShader", "side", "roughness", "metalness", "flatShading"])
      ], 8, _hoisted_1);
    };
  }
});
...
export { _sfc_main };
//# sourceMappingURL=customWaterMesh.vue_vue_type_script_setup_true_lang.DP0YOBvn1767105581793.js.map

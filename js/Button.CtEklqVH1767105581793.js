...
import { c, commonVariables as commonVariables$1, cB, composite, createInjectionKey, derived, cM, cNotM, cE, resolveWrappedSlot, isSlotEmpty, useConfig, useTheme, createKey, changeColor, useThemeClass, call } from './light.CLUJsvFB1767105581793.js';
import { NFadeInExpandTransition, isSafari } from './browser.0EGmEZTw1767105581793.js';
import { isBrowser, iconSwitchTransition, NIconSwitchTransition, NBaseLoading, useFormItem, color2Class } from './Loading.DMQwrvK31767105581793.js';
...
const {defineComponent: defineComponent$1,h: h$1,nextTick,onBeforeUnmount,ref: ref$1,toRef} = await importShared('vue');
const NBaseWave = defineComponent$1({
  name: 'BaseWave',
  props: {
    clsPrefix: {
      type: String,
...
const {computed,defineComponent,h,inject,ref,watchEffect} = await importShared('vue');
...
export { Button, NBaseWave, XButton, buttonGroupInjectionKey, buttonLight, buttonProps, fadeInWidthExpandTransition, self };
//# sourceMappingURL=Button.CtEklqVH1767105581793.js.map

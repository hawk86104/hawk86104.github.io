import{importShared as r}from"./3d-tiles-renderer.D7aKj17a1778841428869.js";import{Pane as B}from"./tweakpane.BQRZXf8M1778841428869.js";import{useLoop as M,customShaderMaterial_default as W,OrbitControls_default as E}from"./index.Dqlz0Bbg1778841428869.js";import{_sfc_main as D}from"./reflectorDUDV.vue_vue_type_script_setup_true_lang.ZnnAvcNW1778841428869.js";import{useTexture$1 as O}from"./index.vue_vue_type_script_setup_true_lang.C2kLpPY21778841428869.js";import"./index.vue_vue_type_script_setup_true_lang.DRm1mceI1778841428869.js";const{withAsyncContext:k,defineComponent:A}=await r("vue"),{unref:m,createElementVNode:S,createVNode:L,openBlock:R,createElementBlock:V}=await r("vue"),$=["rotateX"],z=["position","aIndex","aNormal"],c=await r("three"),{useAttrs:H,watch:G}=await r("vue"),F=`
varying vec2 vMapUv;

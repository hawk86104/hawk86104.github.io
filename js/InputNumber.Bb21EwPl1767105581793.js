...
import { createTheme, derived, c, cB, resolveWrappedSlot, useConfig, useTheme, rgba, resolveSlot, call } from './light.CLUJsvFB1767105581793.js';
import { inputLight, NInput } from './Input.xoI_2nKL1767105581793.js';
import { buttonLight, XButton } from './Button.CtEklqVH1767105581793.js';
import { useLocale } from './Suffix.BS0_grS71767105581793.js';
import { useFormItem } from './Loading.DMQwrvK31767105581793.js';
import { useMergedState, on } from './use-merged-state.tu3_gbk31767105581793.js';
...
const RemoveIcon = defineComponent$1({
  name: 'Remove',
  render() {
    return h$1("svg", {
...
const {computed,defineComponent,h,nextTick,ref,toRef,watch,watchEffect} = await importShared('vue');
...
export { NInputNumber, RemoveIcon, inputNumberProps };
//# sourceMappingURL=InputNumber.Bb21EwPl1767105581793.js.map

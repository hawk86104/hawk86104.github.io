...
var literals100 = literals
  , operators = operators$1
  , builtins100 = builtins
  , literals300es = literals300es$1
  , builtins300es = builtins300es$1;
...
const D = /*@__PURE__*/getDefaultExportFromCjs(string);

var glslTokenDepth;
var hasRequiredGlslTokenDepth;

function requireGlslTokenDepth () {
	if (hasRequiredGlslTokenDepth) return glslTokenDepth;
	hasRequiredGlslTokenDepth = 1;
	glslTokenDepth = getTokenDepth;
	...
	return glslTokenDepth;
}

var glslTokenScope;
var hasRequiredGlslTokenScope;

function requireGlslTokenScope () {
	if (hasRequiredGlslTokenScope) return glslTokenScope;
	hasRequiredGlslTokenScope = 1;
	glslTokenScope = tokenScope;
	...
	return glslTokenScope;
}

var glslTokenProperties;
var hasRequiredGlslTokenProperties;

function requireGlslTokenProperties () {
	if (hasRequiredGlslTokenProperties) return glslTokenProperties;
	hasRequiredGlslTokenProperties = 1;
	glslTokenProperties = properties;
...
var ignored;
var hasRequiredIgnored;

function requireIgnored () {
	if (hasRequiredIgnored) return ignored;
	hasRequiredIgnored = 1;
	ignored = {
	    'precision': true
	  , 'highp': true
	  , 'mediump': true
...
var glslTokenAssignments;
var hasRequiredGlslTokenAssignments;

function requireGlslTokenAssignments () {
	if (hasRequiredGlslTokenAssignments) return glslTokenAssignments;
	hasRequiredGlslTokenAssignments = 1;
	var assignments = requireAssignments();
	var ignoredKeywords = requireIgnored();

	glslTokenAssignments = assigns;
	...
	return glslTokenAssignments;
}

var glslTokenDescope_1 = glslTokenDescope;

function glslTokenDescope(tokens, rename) {
  requireGlslTokenDepth()(tokens);
  requireGlslTokenScope()(tokens);
  requireGlslTokenProperties()(tokens);
  requireGlslTokenAssignments()(tokens);
...
const T = /*@__PURE__*/getDefaultExportFromCjs(glslTokenDescope_1);
...
const K = /*@__PURE__*/getDefaultExportFromCjs(glslTokenString);
...
const A = /*@__PURE__*/getDefaultExportFromCjs(glslTokenFunctions);

const y = await importShared('three');

const {Vector3:b,Vector2:H,Vector4:Y,Matrix3:J,Matrix4:Q,Color:V,Texture:X,MathUtils:Z} = await importShared('three');
const ee = {
  normal: "normal",
  add: "add",
  subtract: "subtract",
...
class x {
  constructor(a, e, t) {
    this.uuid = Z.generateUUID().replace(/-/g, "_"), this.name = "LayerMaterial", this.mode = "normal", this.visible = true;
  ...
  buildShaders(a) {
    ...
    this.vertexShader = this.processFinal(l.vert, true), this.fragmentShader = this.processFinal(l.frag), this.vertexVariables = c.vert, this.fragmentVariables = c.frag, (f = this.onParse) == null || f.call(this, this), this.schema = this.schema.filter((m, w) => {
      const P = m.label;
...
export { $, S, ne };
//# sourceMappingURL=vanilla-BEVDQrzM.Do8d2br_1767105581793.js.map

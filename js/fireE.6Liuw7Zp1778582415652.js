import{importShared as t}from"./3d-tiles-renderer.Croa2fbg1778582415652.js";import{_sfc_main as d}from"./pagesShow.vue_vue_type_script_setup_true_lang.oHCsEM8O1778582415652.js";import{useTres as m,useLoop as f}from"./index.H-N8cTVp1778582415652.js";const{defineComponent:p}=await t("vue"),{createElementVNode:a,normalizeProps:u,guardReactiveProps:h,openBlock:_,createElementBlock:P}=await t("vue"),{ref:x}=await t("vue"),o=await t("three"),y=`
varying vec2 vUv;
void main() {
vUv = uv;

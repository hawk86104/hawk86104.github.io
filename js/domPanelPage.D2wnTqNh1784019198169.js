import{importShared as d}from"./3d-tiles-renderer.BLqHS9Z21784019198169.js";import{OrbitControls_default as g}from"./index.BhMTM39B1784019198169.js";import{Pane as w}from"./tweakpane.BQRZXf8M1784019198169.js";import{_sfc_main as b}from"./domPanel.vue_vue_type_style_index_0_lang.DqRCiAAn1784019198169.js";import{NModal as C}from"./Modal.CjqA5KJS1784019198169.js";import{NInput as k}from"./Input.a0rtCmf21784019198169.js";import{Button as m}from"./Button.B6PUBDqn1784019198169.js";const{defineComponent:_}=await d("vue"),{createElementVNode:a,unref:r,createVNode:o,normalizeProps:h,guardReactiveProps:y,resolveComponent:B,withCtx:i,createTextVNode:u,Fragment:T,openBlock:N,createElementBlock:z}=await d("vue"),P={position:[1,2,3]},{reactive:M,ref:f}=await d("vue"),I=_({__name:"domPanelPage",setup(V){const t=M({center:!1,transform:!0,sprite:!1,distanceFactor:3,domContent:`

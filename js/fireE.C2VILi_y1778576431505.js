import{importShared as t}from"./3d-tiles-renderer.7YO7KeT51778576431505.js";import{_sfc_main as d}from"./pagesShow.vue_vue_type_script_setup_true_lang.Bxn4gjIr1778576431505.js";import{useTres as m,useLoop as f}from"./index.DM5tecXG1778576431505.js";const{defineComponent:p}=await t("vue"),{createElementVNode:a,normalizeProps:u,guardReactiveProps:h,openBlock:_,createElementBlock:P}=await t("vue"),{ref:x}=await t("vue"),o=await t("three"),y=`
varying vec2 vUv;
void main() {
vUv = uv;

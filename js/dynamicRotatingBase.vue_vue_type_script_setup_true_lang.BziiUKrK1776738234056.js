import{importShared as x}from"./3d-tiles-renderer.klHMwsjv1776738234056.js";import{useTres as oe,useLoop as H,useTextures as Ue,useGLTF as J,useAnimations as Ge,useTexture as Ie,customShaderMaterial_default as je,useTresContext as He}from"./index.B55MJKry1776738234056.js";import{useFBO as de,useTexture as Qe}from"./index.vue_vue_type_script_setup_true_lang.08P_4SsW1776738234056.js";import"./index.vue_vue_type_script_setup_true_lang.BrqtdOwE1776738234056.js";import{instance as se}from"./Resource.6DEqRLXL1776738234056.js";import{gsapWithCSS as ue}from"./index.C1NmcAq51776738234056.js";import{EffectComposer as Fe,RenderPass as Oe,ShaderPass as Xe}from"./RenderPass.Bipye1-m1776738234056.js";import{UnrealBloomPass as Ne}from"./UnrealBloomPass.3kZ2JHLa1776738234056.js";import{BatchedRenderer as Ye,QuarksLoader as Ze,ConstantValue as Je,ConstantColor as Ke}from"./three.quarks.esm.B_ET_VNG1776738234056.js";var qe=Object.defineProperty,et=(_,e,n)=>e in _?qe(_,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):_[e]=n,re=(_,e,n)=>(et(_,typeof e!="symbol"?e+"":e,n),n);const{OrthographicCamera:tt,PlaneGeometry:at,Mesh:ot}=await x("three");class ve{constructor(e){re(this,"camera",new tt(-1,1,1,-1,0,1)),re(this,"geometry",new at(2,2)),re(this,"mesh"),this.mesh=new ot(this.geometry,e)}get material(){return this.mesh.material}set material(e){this.mesh.material=e}dispose(){this.mesh.geometry.dispose()}render(e){e.render(this.mesh,this.camera)}}const nt={uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
    varying vec2 vUv;

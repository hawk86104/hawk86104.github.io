import { zr, importShared, Kk } from './index.BxB45aCK1767105581793.js';
...
Truc.prototype.init = function () {
    ...
    this.sprite = new THREE$1.Sprite(this.material);
};
...
Truc.prototype.shuffle = function () {
    ...
    this.tt = this.scale2;
    gsapWithCSS.to(this.sprite.scale, 1, { x: this.scale2, y: this.scale2, ease:'power1.inOut' });
    gsapWithCSS.to(this.sprite.position, this.scale2, { y: this.sprite.position.y + 100, ease:'power1.inOut' });


    this.t1 = 1;
    gsapWithCSS.to(this.sprite.position, this.t1, {
    ...
    gsapWithCSS.to(this.material, 1, {
        opacity: 0,
        delay: this.tt - 1,
        ease: 'power1.inOut',
...
const {createElementVNode:_createElementVNode,unref:_unref,normalizeProps:_normalizeProps,guardReactiveProps:_guardReactiveProps,createVNode:_createVNode,resolveComponent:_resolveComponent,withCtx:_withCtx,openBlock:_openBlock,createBlock:_createBlock} = await importShared('vue');
...
//# sourceMappingURL=bubble.Bq4Nll2C1767105581793.js.map

import{importShared as r}from"./3d-tiles-renderer.C1lnn_Zc1778809216327.js";import{useLoop as w,customShaderMaterial_default as T}from"./index.CS4UwI0_1778809216327.js";import{buildRoundedPath as U}from"./buildFlexiblePipe.D6j4YPn11778809216327.js";const{defineComponent:R}=await r("vue"),{createElementVNode:b,unref:G,createVNode:E,openBlock:L,createElementBlock:P}=await r("vue"),D={renderOrder:9999},B=["args"],{watch:f,ref:k}=await r("vue"),a=await r("three"),A=`
	varying vec2 vUv;
	void main() {
		vUv = vec3( uv, 1 ).xy; 
	}

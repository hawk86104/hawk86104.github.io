import { importShared, _l, nz, Kk } from './index.BxB45aCK1767105581793.js';
...
const {normalizeProps:_normalizeProps$1,guardReactiveProps:_guardReactiveProps$1,openBlock:_openBlock$2,createElementBlock:_createElementBlock$1} = await importShared('vue');

const {watch} = await importShared('vue');

const THREE = await importShared('three');
const _sfc_main$2 = /* @__PURE__ */ _defineComponent$2({
  __name: "revealEffectMaterial",
  props: {
    uProgress: { default: 0 },
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return _openBlock$2(), _createElementBlock$1("TresShaderMaterial", _normalizeProps$1(_guardReactiveProps$1(smState)), null, 16);
    };
  }
});
...
const _hoisted_1 = { position: [0, 0, -16] };
const _sfc_main$1 = /* @__PURE__ */ _defineComponent$1({
  __name: "revealEffectMesh",
  async setup(__props) {
    let __temp, __restore;
    const texture = ([__temp, __restore] = _withAsyncContext(() => nz("./plugins/visualArts/video/vlg.mp4", { loop: true })), __temp = await __temp, __restore(), __temp) || null;
    return (_ctx, _cache) => {
      return _openBlock$1(), _createElementBlock("TresMesh", _hoisted_1, [
        _cache[0] || (_cache[0] = _createElementVNode$1("TresPlaneGeometry", { args: [16, 10] }, null, -1)),
        _createVNode$1(_sfc_main$2, _mergeProps$1(_ctx.$attrs, { texture: _unref$1(texture) }), null, 16, ["texture"])
      ]);
    };
  }
});
    ...
    return (_ctx, _cache) => {
      ...
      return _openBlock(), _createBlock(_component_TresCanvas, _mergeProps(state, {
        ...
        default: _withCtx(() => [
          ...
          _createVNode(_unref(_sfc_main$3), _mergeProps({ position: [0, -6, 0] }, reflectorState), null, 16)
        ]),
        _: 1
      }, 16);
    };
...
//# sourceMappingURL=revealEffect.Dx7fS8v_1767105581793.js.map

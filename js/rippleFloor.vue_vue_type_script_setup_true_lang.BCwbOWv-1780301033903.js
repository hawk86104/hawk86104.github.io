import{importShared as t}from"./3d-tiles-renderer.BxuoBjA31780301033903.js";import{useLoop as s,customShaderMaterial_default as c}from"./index.mXVkyHhk1780301033903.js";const{defineComponent:v}=await t("vue"),{createElementVNode:u,unref:m,createVNode:y,openBlock:h,createElementBlock:g}=await t("vue"),p=["rotation-x"],{onMounted:C,watch:L,reactive:S}=await t("vue"),l=await t("three"),z=`
    varying vec2 vUv;
    void main() {
        vUv = uv;
...
`,k=v({__name:"rippleFloor",props:{color:{default:"#ffed00"},flySpeed:{default:3},flyIntensity:{default:.3},dotSize:{default:.03},lineColor:{default:"#66f5ff"},floorColor1:{default:"#4c6480"},floorColor2:{default:"#acb4c0"},gridSize:{default:50},lineWidth:{default:.02},paused:{type:Boolean,default:!1}},setup(f){const o=f,e=S({time:{value:0},color1:{value:new l.Color(o.floorColor1)},color2:{value:new l.Color(o.floorColor2)},lineColor:{value:new l.Color(o.lineColor)},flyLineColor:{value:new l.Color(o.lineColor)},gridSize:{value:o.gridSize},lineWidth:{value:o.lineWidth},flySpeed:{value:o.flySpeed},flyIntensity:{value:o.flyIntensity},dotSize:{value:o.dotSize}}),{onBeforeRender:d}=s();let i=0;d(({delta:r})=>{o.paused||(i+=r,e.time.value=i)});const a=()=>{e.color1.value=new l.Color(o.floorColor1),e.color2.value=new l.Color(o.floorColor2),e.lineColor.value=new l.Color(o.lineColor),e.flyLineColor.value=new l.Color(o.lineColor),e.gridSize.value=o.gridSize,e.lineWidth.value=o.lineWidth,e.flySpeed.value=o.flySpeed,e.flyIntensity.value=o.flyIntensity,e.dotSize.value=o.dotSize};return C(()=>{a()}),L(()=>[o.flySpeed,o.flyIntensity,o.dotSize,o.lineColor,o.floorColor1,o.floorColor2,o.gridSize,o.lineWidth],a),(r,n)=>(h(),g("TresMesh",{"rotation-x":-Math.PI/2},[n[0]||(n[0]=u("TresPlaneGeometry",{args:[10,10]},null,-1)),y(m(c),{baseMaterial:l.MeshBasicMaterial,uniforms:e,"vertex-shader":z,"fragment-shader":M,side:l.DoubleSide,silent:""},null,8,["baseMaterial","uniforms","side"])],8,p))}});export{k as _sfc_main};

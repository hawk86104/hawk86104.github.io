...
const {BufferGeometry,FileLoader,Float32BufferAttribute,Loader,Color,SRGBColorSpace: SRGBColorSpace$1} = await importShared('three');
...
const _sfc_main$1 = /* @__PURE__ */ _defineComponent$1({
  ...
  async setup(__props) {
    ...
    const geometry = ([__temp, __restore] = _withAsyncContext(() => useLoader(PLYLoader, "./plugins/gaussianSplatting/model/luigi.ply")), __temp = await __temp, __restore(), __temp);
    geometry.computeVertexNormals();
    return (_ctx, _cache) => {
      return _openBlock$1(), _createElementBlock("TresPoints", { geometry: _unref$1(geometry) }, [..._cache[0] || (_cache[0] = [
        _createElementVNode$1("TresPointsMaterial", {
          size: 0.01,
          color: "#0000ff"
        }, null, -1)
      ])], 8, _hoisted_1);
      ...
      return _openBlock(), _createBlock(_unref(ol), _mergeProps(state, { "window-size": "" }), {
        default: _withCtx(() => [
          ...
          (_openBlock(), _createBlock(_Suspense, null, {
            default: _withCtx(() => [
              _createVNode(_sfc_main$1, { position: [0, 0.7, 0] })
            ]),
            _: 1
          })),
...
//# sourceMappingURL=plyPage.D7IqoFU31767105581793.js.map

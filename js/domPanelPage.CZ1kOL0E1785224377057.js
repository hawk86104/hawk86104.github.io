import{importShared as d}from"./3d-tiles-renderer.BvgPpO0u1785224377057.js";import{OrbitControls_default as g}from"./index.BVxE_rH-1785224377057.js";import{Pane as w}from"./tweakpane.BQRZXf8M1785224377057.js";import{_sfc_main as b}from"./domPanel.vue_vue_type_style_index_0_lang.BM8cEHvg1785224377057.js";import{NModal as C}from"./Modal.CdP0mF_L1785224377057.js";import{NInput as k}from"./Input.Buz7lxWg1785224377057.js";import{Button as m}from"./Button.D1hucd011785224377057.js";const{defineComponent:_}=await d("vue"),{createElementVNode:a,unref:r,createVNode:o,normalizeProps:h,guardReactiveProps:y,resolveComponent:B,withCtx:i,createTextVNode:u,Fragment:T,openBlock:N,createElementBlock:z}=await d("vue"),P={position:[1,2,3]},{reactive:M,ref:f}=await d("vue"),I=_({__name:"domPanelPage",setup(V){const t=M({center:!1,transform:!0,sprite:!1,distanceFactor:3,domContent:`

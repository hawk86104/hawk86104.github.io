import{importShared as n}from"./3d-tiles-renderer.Croa2fbg1778582415652.js";import{_sfc_main as f}from"./earth.vue_vue_type_script_setup_true_lang.D-YC6MpW1778582415652.js";import{useLoop as _,OrbitControls_default as g}from"./index.H-N8cTVp1778582415652.js";import{Pane as C}from"./tweakpane.BQRZXf8M1778582415652.js";const{defineComponent:w}=await n("vue"),{createElementVNode:m,normalizeProps:y,guardReactiveProps:h,openBlock:B,createElementBlock:P}=await n("vue"),r=await n("three"),{watch:x}=await n("vue"),T=w({__name:"highlightScan",props:{color:{default:"#FFFFFF"},opacity:{default:1},speed:{default:1}},setup(u){const e=u,o={uniforms:{uTime:{value:0},pointNum:{value:new r.Vector2(32,16)},uColor:{value:new r.Color(e.color)},uOpacity:{value:e.opacity}},transparent:!0,vertexShader:`
varying vec2 vUv;

import { importShared, Fs, ol, Kk } from './index.BxB45aCK1767105581793.js';
...
const {openBlock:_openBlock$1,createElementBlock:_createElementBlock} = await importShared('vue');

const _hoisted_1 = ["object"];
const {watch,onUnmounted,ref,toRaw} = await importShared('vue');
const _sfc_main$1 = /* @__PURE__ */ _defineComponent$1({
  ...
  async setup(__props) {
    ...
    let oneSplat = ([__temp, __restore] = _withAsyncContext(() => loader.loadAsync(props.url)), __temp = await __temp, __restore(), __temp);
    const modelSplat = ref(null);
    ...
    const disposeThis = () => {
      if (modelSplat.value) {
        ...
        if (modelSplat.value.material) {
          modelSplat.value.material.dispose();
        }
      }
    };
    onUnmounted(() => {
...
const {createElementVNode:_createElementVNode,unref:_unref,createVNode:_createVNode,mergeProps:_mergeProps,Suspense:_Suspense,withCtx:_withCtx,openBlock:_openBlock,createBlock:_createBlock} = await importShared('vue');
      ...
      return _openBlock(), _createBlock(_unref(ol), _mergeProps(state, { "window-size": "" }), {
        default: _withCtx(() => [
          ...
          (_openBlock(), _createBlock(_Suspense, null, {
            default: _withCtx(() => [
              _createVNode(_sfc_main$1, _mergeProps(splatConfig, {
                position: [0, 0.7, 0],
                "rotate-x": -Math.PI
              }), null, 16, ["rotate-x"])
            ]),
...
//# sourceMappingURL=splatPage.DkTqITfP1767105581793.js.map

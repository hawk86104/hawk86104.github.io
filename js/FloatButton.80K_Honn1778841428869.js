import{importShared as M}from"./3d-tiles-renderer.D7aKj17a1778841428869.js";import{derived as B,cB as x,cM as y,c as l,cE as a,createInjectionKey as D,useConfig as j,useTheme as R,useThemeClass as k,resolveWrappedSlot as K,resolveSlot as W,call as z}from"./light.DlZGv-1V1778841428869.js";import{formatLength as u}from"./format-length.BHvmju661778841428869.js";import{NBaseIcon as J,ErrorIcon as Q}from"./Close.D96uo7741778841428869.js";import{useMergedState as X,on as Y,off as Z}from"./use-merged-state.BZgnRjFF1778841428869.js";function oo(o){const{popoverColor:e,dividerColor:r,borderRadius:s}=o;return{color:e,buttonBorderColor:r,borderRadiusSquare:s,boxShadow:"0 2px 8px 0px rgba(0, 0, 0, .12)"}}const eo={common:B,self:oo},to=x("float-button-group",[x("float-button",`
 position: relative;
 `),y("square-shape",`

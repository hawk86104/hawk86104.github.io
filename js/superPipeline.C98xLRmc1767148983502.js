import{importShared as t}from"./3d-tiles-renderer.DZNovkLO1767148983502.js";import{argestCircle_default as i}from"./argestCircle.WJcEHp9_1767148983502.js";var f=`varying vec2 vUv;
uniform float uTime;
#define FAR 50.
...
}`;const{defineComponent:c}=await t("vue"),{createElementVNode:e,normalizeProps:d,guardReactiveProps:s,resolveComponent:v,mergeProps:p,withCtx:m,openBlock:x,createBlock:u}=await t("vue"),y={ref:"perspectiveCameraRef",position:[0,0,1800],fov:45,near:1,far:1e4},b=["rotation-x"],{AdditiveBlending:h,DoubleSide:D}=await t("three"),q=c({__name:"superPipeline",setup(g){const o={clearColor:"#000000",shadows:!0,alpha:!1,useLegacyLights:!0},a={uniforms:{uTime:{type:"f",value:0}},vertexShader:i,fragmentShader:f,side:D,blending:h,depthWrite:!1,transparent:!0},r=function(){a.uniforms.uTime.value+=.03};return(O,n)=>{const l=v("TresCanvas");return x(),u(l,p(o,{"window-size":"",onLoop:r}),{default:m(()=>[e("TresPerspectiveCamera",y,null,512),n[1]||(n[1]=e("TresAmbientLight",{color:"#ffffff"},null,-1)),n[2]||(n[2]=e("TresDirectionalLight",{position:[100,100,0],intensity:.5,color:"#ffffff"},null,-1)),e("TresMesh",{ref:"quanMeshRef","rotation-x":Math.PI},[n[0]||(n[0]=e("TresPlaneGeometry",{args:[4e3,4e3]},null,-1)),e("TresShaderMaterial",d(s(a)),null,16)],8,b)]),_:1},16)}}});export{q as default};

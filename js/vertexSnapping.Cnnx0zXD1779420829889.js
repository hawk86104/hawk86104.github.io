import{importShared as t}from"./3d-tiles-renderer.Bu1x4XVm1779420829889.js";import{useGLTF as P,TresCanvas_default as R,OrbitControls_default as x}from"./index.3RZw9hAt1779420829889.js";import{_sfc_main as h,_sfc_main$1 as c}from"./index.vue_vue_type_script_setup_true_lang.RrtnndFm1779420829889.js";import"./index.vue_vue_type_script_setup_true_lang.tmtj5AmH1779420829889.js";import{Pane as M}from"./tweakpane.BQRZXf8M1779420829889.js";const{defineComponent:w}=await t("vue"),{openBlock:C,createElementBlock:B}=await t("vue"),T=["object"],y=await t("three"),{toRef:b,watch:k}=await t("vue"),E=w({__name:"com",props:{uSnappingResolution:{default:6},srcMaterial:{default:()=>new y.MeshStandardMaterial({color:65280,roughness:.5,metalness:.5})}},setup(u){const i=u,o=b(i.uSnappingResolution);return i.srcMaterial.onBeforeCompile=n=>{n.uniforms.uSnappingResolution=o,n.vertexShader=n.vertexShader.replace("#include <common>",`
			#include <common>

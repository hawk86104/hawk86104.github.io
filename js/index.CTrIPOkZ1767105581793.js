...
import { version } from './constants.l92JOT9R1767105581793.js';
import { useLoader } from './customShaderMaterial.vue_vue_type_script_setup_true_lang.rDMIDGqx1767105581793.js';

const {BufferGeometry: BufferGeometry$2,BufferAttribute: BufferAttribute$2,InterleavedBuffer: InterleavedBuffer$1,InterleavedBufferAttribute: InterleavedBufferAttribute$1,TrianglesDrawMode,TriangleFanDrawMode: TriangleFanDrawMode$1,TriangleStripDrawMode: TriangleStripDrawMode$1,Vector3: Vector3$1,Float32BufferAttribute} = await importShared('three');
...
const {Loader: Loader$1,LoaderUtils,FileLoader: FileLoader$1,Color,SpotLight,PointLight,DirectionalLight,MeshBasicMaterial,MeshPhysicalMaterial,Vector2,Matrix4,Vector3,Quaternion,InstancedMesh,InstancedBufferAttribute,Object3D,TextureLoader,ImageBitmapLoader,BufferAttribute: BufferAttribute$1,InterleavedBuffer,InterleavedBufferAttribute,LinearFilter,LinearMipmapLinearFilter,RepeatWrapping,PointsMaterial,Material,LineBasicMaterial,MeshStandardMaterial,DoubleSide,PropertyBinding,BufferGeometry: BufferGeometry$1,SkinnedMesh,Mesh,TriangleStripDrawMode,TriangleFanDrawMode,LineSegments,Line,LineLoop,Points,Group,PerspectiveCamera,MathUtils,OrthographicCamera,Skeleton,AnimationClip,Bone,InterpolateLinear,NearestFilter,NearestMipmapNearestFilter,LinearMipmapNearestFilter,NearestMipmapLinearFilter,ClampToEdgeWrapping,MirroredRepeatWrapping,InterpolateDiscrete,FrontSide,Texture,VectorKeyframeTrack,NumberKeyframeTrack,QuaternionKeyframeTrack,Box3,Sphere,Interpolant} = await importShared('three');
...
class GLTFParser {
  ...
  loadAccessor(accessorIndex) {
    ...
    if (accessorDef.bufferView === void 0 && accessorDef.sparse === void 0) {
      ...
      return Promise.resolve(new BufferAttribute$1(array, itemSize, normalized));
    }
    ...
    return Promise.all(pendingBufferViews).then(function(bufferViews) {
      ...
      if (accessorDef.sparse !== void 0) {
        ...
        if (bufferView !== null) {
          bufferAttribute = new BufferAttribute$1(
...
const {Loader,FileLoader,BufferGeometry,BufferAttribute} = await importShared('three');
...
function setExtensions(options, extendLoader) {
  return (loader) => {
    if (extendLoader) {
      extendLoader(loader);
    }
...
async function useGLTF(path, options = {
  draco: true
}, extendLoader) {
  const gltfModel = await useLoader(GLTFLoader, path, setExtensions(options, extendLoader));
  dracoLoader?.dispose();
  dracoLoader = null;
  return gltfModel;
}
...
export { useGLTF };
//# sourceMappingURL=index.CTrIPOkZ1767105581793.js.map

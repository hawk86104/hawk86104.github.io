...
const {BufferGeometry,FileLoader,Float32BufferAttribute,Group,LineBasicMaterial,LineSegments,Loader,Material,Mesh,MeshPhongMaterial,Points,PointsMaterial,Vector3,Color,SRGBColorSpace} = await importShared('three');
...
const loadOBJ = (filepath, loader) => new Promise((resolve, reject) => {
...
export { OBJLoader, loadOBJ };
//# sourceMappingURL=util.B1yBATjg1767105581793.js.map

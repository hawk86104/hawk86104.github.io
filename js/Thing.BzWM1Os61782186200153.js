import{importShared as _}from"./3d-tiles-renderer.DqAp7iVI1782186200153.js";import{derived as D,composite as C,c as g,cB as r,insideModal as q,insidePopover as J,cNotM as Y,cM as $,cE as v,useConfig as L,useTheme as y,createKey as F,useThemeClass as H,createInjectionKey as Z,throwError as ee}from"./light.DI9XvSZz1782186200153.js";import{flatten as oe,repeat as re}from"./Scrollbar.DDtWC0hh1782186200153.js";import{getSlot as te}from"./Space.fwwNoE-r1782186200153.js";import{useCompitable as ne}from"./use-compitable.CulAoDrX1782186200153.js";import{kebabCase as ie}from"./index.BzWE9vvh1782186200153.js";import{useRtl as Q}from"./use-rtl.CTOquEI_1782186200153.js";function K(e,o="default",t=[]){const{children:i}=e;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[o];if(typeof l=="function")return l()}return t}const le={thPaddingBorderedSmall:"8px 12px",thPaddingBorderedMedium:"12px 16px",thPaddingBorderedLarge:"16px 24px",thPaddingSmall:"0",thPaddingMedium:"0",thPaddingLarge:"0",tdPaddingBorderedSmall:"8px 12px",tdPaddingBorderedMedium:"12px 16px",tdPaddingBorderedLarge:"16px 24px",tdPaddingSmall:"0 0 8px 0",tdPaddingMedium:"0 0 12px 0",tdPaddingLarge:"0 0 16px 0"};function de(e){const{tableHeaderColor:o,textColor2:t,textColor1:i,cardColor:l,modalColor:n,popoverColor:s,dividerColor:c,borderRadius:h,fontWeightStrong:f,lineHeight:d,fontSizeSmall:a,fontSizeMedium:x,fontSizeLarge:u}=e;return Object.assign(Object.assign({},le),{lineHeight:d,fontSizeSmall:a,fontSizeMedium:x,fontSizeLarge:u,titleTextColor:i,thColor:C(l,o),thColorModal:C(n,o),thColorPopover:C(s,o),thTextColor:i,thFontWeight:f,tdTextColor:t,tdColor:l,tdColorModal:n,tdColorPopover:s,borderColor:C(l,c),borderColorModal:C(n,c),borderColorPopover:C(s,c),borderRadius:h})}const ae={common:D,self:de},se=g([r("descriptions",{fontSize:"var(--n-font-size)"},[r("descriptions-separator",`

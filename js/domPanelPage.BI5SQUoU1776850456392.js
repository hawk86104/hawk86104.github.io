import{importShared as d}from"./3d-tiles-renderer.C6RRf79a1776850456392.js";import{OrbitControls_default as g}from"./index.BLDmQRJv1776850456392.js";import{Pane as w}from"./tweakpane.BQRZXf8M1776850456392.js";import{_sfc_main as b}from"./domPanel.vue_vue_type_style_index_0_lang.B6nznFHo1776850456392.js";import{NModal as C}from"./Modal.BVO5Umx01776850456392.js";import{NInput as k}from"./Input.BLo82e1H1776850456392.js";import{Button as m}from"./Button.Cz509U3C1776850456392.js";const{defineComponent:_}=await d("vue"),{createElementVNode:a,unref:r,createVNode:o,normalizeProps:h,guardReactiveProps:y,resolveComponent:B,withCtx:i,createTextVNode:u,Fragment:T,openBlock:N,createElementBlock:z}=await d("vue"),P={position:[1,2,3]},{reactive:M,ref:f}=await d("vue"),I=_({__name:"domPanelPage",setup(V){const t=M({center:!1,transform:!0,sprite:!1,distanceFactor:3,domContent:`

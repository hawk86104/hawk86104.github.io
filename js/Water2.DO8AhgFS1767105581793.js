...
const {Color: Color$1,Matrix4: Matrix4$1,Mesh: Mesh$1,PerspectiveCamera,Plane,Quaternion,ShaderMaterial: ShaderMaterial$1,UniformsUtils: UniformsUtils$1,Vector3,Vector4: Vector4$1,WebGLRenderTarget,HalfFloatType} = await importShared('three');
 ...
 */
class Refractor extends Mesh$1 {
	...
	constructor( geometry, options = {} ) {
		...
		const updateVirtualCamera = ( function () {
			...
			const clipVector = new Vector4$1();
			const q = new Vector4$1();
...
const {Clock,Color,Matrix4,Mesh,RepeatWrapping,ShaderMaterial,TextureLoader,UniformsLib,UniformsUtils,Vector2,Vector4} = await importShared('three');
...
export { Water };
//# sourceMappingURL=Water2.DO8AhgFS1767105581793.js.map

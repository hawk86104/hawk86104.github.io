import{importShared as t}from"./3d-tiles-renderer.klHMwsjv1776738234056.js";import{OrbitControls_default as _,component_default$4 as x}from"./index.B55MJKry1776738234056.js";import{Pane as T}from"./tweakpane.BQRZXf8M1776738234056.js";var w=`varying vec2 vUv;
void main()
{
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    vUv = uv;
}`,k=`uniform float uGridThickness;
...
}`;const{defineComponent:W}=await t("vue"),{createElementVNode:c,normalizeProps:D,guardReactiveProps:y,openBlock:F,createElementBlock:b}=await t("vue"),B=["rotate-x"],l=await t("three"),{watchEffect:P}=await t("vue"),A=W({__name:"gridFloor",props:{gridColor:{default:"#c4d6ff"},gridThickness:{default:.02},crossColor:{default:"#7a91df"},crossThickness:{default:.02},uCross:{default:.2},floorColor:{default:"#ffffff"}},setup(u){const n=u,e={vertexShader:w,fragmentShader:k,side:l.DoubleSide,transparent:!0,uniforms:{uFloorColor:{value:new l.Color(n.floorColor)},uGridThickness:{value:n.gridThickness},uGridColor:{value:new l.Color(n.gridColor)},uCrossThickness:{value:n.crossThickness},uCross:{value:n.uCross},uCrossColor:{value:new l.Color(n.crossColor)}}};return P(()=>{e.uniforms.uFloorColor.value.set(n.floorColor),e.uniforms.uGridColor.value.set(n.gridColor),e.uniforms.uCrossColor.value.set(n.crossColor),e.uniforms.uGridThickness.value=n.gridThickness,e.uniforms.uCrossThickness.value=n.crossThickness,e.uniforms.uCross.value=n.uCross}),(r,o)=>(F(),b("TresMesh",{"rotate-x":-Math.PI/2},[o[0]||(o[0]=c("TresPlaneGeometry",{args:[10,10,32,32]},null,-1)),c("TresShaderMaterial",D(y(e)),null,16)],8,B))}}),{defineComponent:S}=await t("vue"),{createElementVNode:s,unref:v,normalizeProps:f,guardReactiveProps:g,createVNode:a,Suspense:V,withCtx:m,openBlock:p,createBlock:C,resolveComponent:U,mergeProps:z}=await t("vue"),{ACESFilmicToneMapping:E}=await t("three"),{reactive:d}=await t("vue"),j=S({__name:"gridFloor",setup(u){const n=d({alpha:!0,toneMapping:E,windowSize:!0,clearColor:3355443}),e=d({enableDamping:!0,autoRotate:!1}),r=d({gridColor:"#ffffff",crossColor:"#ef57ff",floorColor:"#000000",gridThickness:.02,crossThickness:.03,uCross:.29}),o=new T;return o.addBinding(r,"gridColor",{label:"网格颜色"}),o.addBinding(r,"gridThickness",{label:"网格厚度",min:.01,max:1,step:.01}),o.addBinding(r,"crossColor",{label:"十字颜色"}),o.addBinding(r,"crossThickness",{label:"十字厚度",min:.01,max:1,step:.01}),o.addBinding(r,"uCross",{label:"十字大小",min:.01,max:1,step:.01}),o.addBinding(r,"floorColor",{label:"地板颜色"}),(G,i)=>{const h=U("TresCanvas");return p(),C(h,z(n,{"window-size":""}),{default:m(()=>[i[0]||(i[0]=s("TresPerspectiveCamera",{position:[6,6,6],fov:45,near:.1,far:1e3},null,-1)),a(v(_),f(g(e)),null,16),i[1]||(i[1]=s("TresAmbientLight",{intensity:.5},null,-1)),i[2]||(i[2]=s("TresDirectionalLight",{position:[15,15,15],intensity:1},null,-1)),i[3]||(i[3]=s("TresMesh",{position:[0,.5,0],scale:.2},[s("TresTorusKnotGeometry",{args:[1,.35,100,32]}),s("TresMeshStandardMaterial",{color:"#ff33ff",roughness:0,metalness:1})],-1)),a(A,f(g(r)),null,16),(p(),C(V,null,{default:m(()=>[a(v(x),{files:["pos-x.jpg","neg-x.jpg","pos-y.jpg","neg-y.jpg","pos-z.jpg","neg-z.jpg"],path:"https://opensource.cdn.icegl.cn/images/skyBox/6jpg/"},null,8,["path"])]),_:1}))]),_:1},16)}}});export{j as default};

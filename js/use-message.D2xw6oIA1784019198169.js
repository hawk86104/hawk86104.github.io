import{importShared as I}from"./3d-tiles-renderer.BLqHS9Z21784019198169.js";import{c as h,commonVariables as ne,createInjectionKey as P,derived as re,cB as w,cE as y,cM as x,useConfig as H,useTheme as M,createKey as C,useThemeClass as se,throwError as te}from"./light.DmHxeE8P1784019198169.js";import{iconSwitchTransition as ie,NIconSwitchTransition as ae,NBaseLoading as ce}from"./Loading.B8Dfi5aO1784019198169.js";import{render as le,NBaseClose as de}from"./Suffix.DcEQKGxg1784019198169.js";import{useRtl as ue}from"./use-rtl.BlRly-1j1784019198169.js";import{NBaseIcon as fe}from"./Close.8YWKgl_61784019198169.js";import{ErrorIcon as ge,WarningIcon as me,SuccessIcon as pe,InfoIcon as he}from"./Warning.BOuUWpVu1784019198169.js";import{NFadeInExpandTransition as ve}from"./browser.BHIbRngx1784019198169.js";import{createId as be}from"./Scrollbar.0vFpCR0h1784019198169.js";function Ce(r,e=[],t){const o={};return Object.getOwnPropertyNames(r).forEach(c=>{e.includes(c)||(o[c]=r[c])}),Object.assign(o,t)}const{cubicBezierEaseInOut:m,cubicBezierEaseOut:xe,cubicBezierEaseIn:$e}=ne;function Ie({overflow:r="hidden",duration:e=".3s",originalTransition:t="",leavingDelay:o="0s",foldPadding:i=!1,enterToProps:c=void 0,leaveToProps:d=void 0,reverse:l=!1}={}){const s=l?"leave":"enter",n=l?"enter":"leave";return[h(`&.fade-in-height-expand-transition-${n}-from,

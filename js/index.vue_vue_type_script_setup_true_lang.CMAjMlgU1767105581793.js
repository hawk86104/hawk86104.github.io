...
const getBrainCurves = () => {
    ...
    PATHS.forEach((path) => {
        ...
        for (let i = 0; i < path.length; i += 3) {
            points.push(new THREE$2.Vector3(path[i], path[i + 1], path[i + 2]));
        }
        const tempcurve = new THREE$2.CatmullRomCurve3(points);
...
const {unref:_unref$1,createElementVNode:_createElementVNode$1,normalizeProps:_normalizeProps,guardReactiveProps:_guardReactiveProps,openBlock:_openBlock$2,createElementBlock:_createElementBlock$2} = await importShared('vue');

const _hoisted_1$1 = { scale: 10 };
const _hoisted_2$1 = ["position", "randoms"];
const {ref,watch: watch$1} = await importShared('vue');

const THREE$1 = await importShared('three');
const density = 10;
const _sfc_main$2 = /* @__PURE__ */ _defineComponent$2({
  __name: "brainParticles",
  props: {
  ...
  setup(__props) {
    ...
    const uniforms = {
      uniforms: {
        color: { value: new THREE$1.Color(props.color) }
      },
      vertexShader: `
			varying vec2 vUv;
    ...
    return (_ctx, _cache) => {
      return _openBlock$2(), _createElementBlock$2("TresPoints", _hoisted_1$1, [
        _createElementVNode$1("TresBufferGeometry", {
          ref_key: "tbRef",
          ref: tbRef,
          position: [_unref$1(positionArray), 3],
          randoms: [_unref$1(randomsArray), 1]
        }, null, 8, _hoisted_2$1),
        _createElementVNode$1("TresShaderMaterial", _normalizeProps(_guardReactiveProps(uniforms)), null, 16)
      ]);
    };
  }
});
...
const {renderList:_renderList,Fragment:_Fragment,openBlock:_openBlock$1,createElementBlock:_createElementBlock$1,createElementVNode:_createElementVNode,mergeProps:_mergeProps} = await importShared('vue');

const _hoisted_1 = { scale: 10 };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return _openBlock$1(), _createElementBlock$1("TresGroup", _hoisted_1, [
        (_openBlock$1(true), _createElementBlock$1(_Fragment, null, _renderList(props.brainCurves, (curve) => {
          return _openBlock$1(), _createElementBlock$1("TresMesh", {
            key: curve.uuid
          }, [
            _createElementVNode("TresTubeGeometry", {
              args: [curve, 64, 1e-3, 2, false]
            }, null, 8, _hoisted_2),
            _createElementVNode("TresShaderMaterial", _mergeProps({ ref_for: true }, tsmConfig), null, 16)
          ]);
        }), 128))
      ]);
    };
...
const {unref:_unref,createVNode:_createVNode,openBlock:_openBlock,createElementBlock:_createElementBlock} = await importShared('vue');
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props) {
    const brainCurves = getBrainCurves();
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock("TresGroup", null, [
        _createVNode(_sfc_main$2, {
          brainCurves: _unref(brainCurves),
          color: __props.particlesColor,
          speed: __props.speed
        }, null, 8, ["brainCurves", "color", "speed"]),
        _createVNode(_sfc_main$1, {
          brainCurves: _unref(brainCurves),
          color: __props.tubesColor
        }, null, 8, ["brainCurves", "color"])
      ]);
    };
  }
});
...
export { _sfc_main };
//# sourceMappingURL=index.vue_vue_type_script_setup_true_lang.CMAjMlgU1767105581793.js.map

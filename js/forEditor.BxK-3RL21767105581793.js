...
const {BackSide,BoxGeometry,Mesh,ShaderMaterial,UniformsUtils,Vector3: Vector3$1} = await importShared('three');
...
const {AnimationClip,AnimationMixer,Matrix4,Quaternion,QuaternionKeyframeTrack,SkeletonHelper,Vector3,VectorKeyframeTrack} = await importShared('three');
 ...
 */
const {ref,shallowReactive} = await importShared('vue');
...
export { Sky, extendMakeEvent, meshAddEvent, onReadySenceOnce, standardizationMeshCopy };
//# sourceMappingURL=forEditor.BxK-3RL21767105581793.js.map

import { c, commonVariables as commonVariables$1, derived, cB, insideModal, insidePopover, asModal, cM, cE, resolveWrappedSlot, useConfig, useTheme, createKey, useThemeClass, call, ensureValidVNode } from './light.CLUJsvFB1767105581793.js';
...
const {computed,defineComponent,h} = await importShared('vue');
const cardBaseProps = {
...
export { NCard, cardBasePropKeys, cardBaseProps, cardLight, cardProps, fadeInScaleUpTransition, keysOf, self };
//# sourceMappingURL=Card.CmCLdudX1767105581793.js.map

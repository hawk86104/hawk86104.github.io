import{importShared as x}from"./3d-tiles-renderer.BmihvCFK1785467111377.js";import{useTres as oe,useLoop as H,useTextures as Ue,useGLTF as J,useAnimations as Ge,useTexture as Ie,customShaderMaterial_default as je,useTresContext as He}from"./index.CuuO6ofn1785467111377.js";import{useFBO as de,useTexture as Qe}from"./index.vue_vue_type_script_setup_true_lang.C7EpJtvq1785467111377.js";import"./index.vue_vue_type_script_setup_true_lang.D94AQFLy1785467111377.js";import{instance as se}from"./Resource.D4_exJbo1785467111377.js";import{gsapWithCSS as ue}from"./index.C1NmcAq51785467111377.js";import{EffectComposer as Fe,RenderPass as Oe,ShaderPass as Xe}from"./RenderPass.CQP5miKw1785467111377.js";import{UnrealBloomPass as Ne}from"./UnrealBloomPass.m2UE7vqb1785467111377.js";import{BatchedRenderer as Ye,QuarksLoader as Ze,ConstantValue as Je,ConstantColor as Ke}from"./three.quarks.esm.HOeZcQk41785467111377.js";var qe=Object.defineProperty,et=(_,e,n)=>e in _?qe(_,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):_[e]=n,re=(_,e,n)=>(et(_,typeof e!="symbol"?e+"":e,n),n);const{OrthographicCamera:tt,PlaneGeometry:at,Mesh:ot}=await x("three");class ve{constructor(e){re(this,"camera",new tt(-1,1,1,-1,0,1)),re(this,"geometry",new at(2,2)),re(this,"mesh"),this.mesh=new ot(this.geometry,e)}get material(){return this.mesh.material}set material(e){this.mesh.material=e}dispose(){this.mesh.geometry.dispose()}render(e){e.render(this.mesh,this.camera)}}const nt={uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
    varying vec2 vUv;

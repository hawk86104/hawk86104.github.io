import{importShared as r}from"./3d-tiles-renderer.XifnC2jl1782977342079.js";import{Pane as B}from"./tweakpane.BQRZXf8M1782977342079.js";import{useLoop as M,customShaderMaterial_default as W,OrbitControls_default as E}from"./index.CksDBZ981782977342079.js";import{_sfc_main as D}from"./reflectorDUDV.vue_vue_type_script_setup_true_lang.Dr-QYpa21782977342079.js";import{useTexture$1 as O}from"./index.vue_vue_type_script_setup_true_lang.C37NIyYf1782977342079.js";import"./index.vue_vue_type_script_setup_true_lang.BuRye2jZ1782977342079.js";const{withAsyncContext:k,defineComponent:A}=await r("vue"),{unref:m,createElementVNode:S,createVNode:L,openBlock:R,createElementBlock:V}=await r("vue"),$=["rotateX"],z=["position","aIndex","aNormal"],c=await r("three"),{useAttrs:H,watch:G}=await r("vue"),F=`
varying vec2 vMapUv;

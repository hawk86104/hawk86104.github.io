import{importShared as n}from"./3d-tiles-renderer.BeXgU1LO1781165239002.js";import{_sfc_main$6 as R}from"./generalFont.vue_vue_type_script_setup_true_lang.BF7dvi8q1781165239002.js";import"./default.vue_vue_type_script_setup_true_lang.zGRRV3kD1781165239002.js";import"./three-mesh-ui.module.C1cEIXhB1781165239002.js";import"./domPanel.vue_vue_type_style_index_0_lang.CV4-i28s1781165239002.js";import{useTresContext as V,useLoop as E,OrbitControls_default as U,component_default$4 as A}from"./index.CKaM2Yp11781165239002.js";import{gsapWithCSS as y}from"./index.C1NmcAq51781165239002.js";import"./index.vue_vue_type_script_setup_true_lang.CTX3nMDG1781165239002.js";import"./index.vue_vue_type_script_setup_true_lang.DwPfON5g1781165239002.js";import{useGLTF as N}from"./index.I1PwgstY1781165239002.js";const I=`
...
`,i=[9205247,6094763,16206474,4059890],{defineComponent:F}=await n("vue"),{unref:b,createElementVNode:k,normalizeProps:G,guardReactiveProps:q,openBlock:L,createElementBlock:O}=await n("vue"),Y=["args"],S=await n("three"),H=F({__name:"background",setup(C,{expose:v}){const{sizes:t}=V();let e=0;const a={uniforms:{u_time:{value:0},u_progress:{value:0},u_aspect:{value:t.width.value/t.height.value},u_color:{value:new S.Color(i[e])}},vertexShader:`
		varying vec2 vUv;
    void main() {
      vUv = uv;
    ...
    void main() {
		...
		`};function o(){++e>=i.length&&(e=0),console.log("backgroud colorIndex",e),a.uniforms.u_color.value=new S.Color(i[e]);const c=a.uniforms.u_progress;y.killTweensOf(c),c.value=0,y.to(c,{duration:5,ease:"power1.out",value:1})}const{onBeforeRender:r}=E();return r(({elapsed:c})=>{a&&(a.uniforms.u_time.value=c)}),v({onClick:o}),(c,w)=>(L(),O("TresMesh",null,[k("TresPlaneGeometry",{args:[b(t).width.value/50,b(t).height.value/50]},null,8,Y),k("TresShaderMaterial",G(q(a)),null,16)]))}}),{defineComponent:X}=await n("vue"),{unref:u,createElementVNode:_,openBlock:j,createElementBlock:D,createCommentVNode:W}=await n("vue"),Z=["rotation","position"],J=["rotation"],K=["geometry","material"],Q=["geometry","material"],m=await n("three"),{ref:B,onMounted:ee}=await n("vue"),oe=X({__name:"model",setup(C,{expose:v}){let t,e;const a=B(!1);ee(async()=>{const{nodes:l,materials:s}=await N("https://opensource.cdn.icegl.cn/model/eCommerce/energy-can.glb");t=l,e=s,e.Body.metalness=0,e.Body.roughness=1,e.Body.onBeforeCompile=g=>{g.uniforms=Object.assign(g.uniforms,o),g.vertexShader=g.vertexShader.replace("#include <common>",`
          #include <common>
          varying vec2 vUv;

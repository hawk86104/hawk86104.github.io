...
const {createElementVNode:_createElementVNode,normalizeProps:_normalizeProps,guardReactiveProps:_guardReactiveProps,openBlock:_openBlock$1,createElementBlock:_createElementBlock} = await importShared('vue');
  ...
  setup(__props) {
    ...
    onBeforeRender(({ elapsed }) => {
      if (sprite.value && camera.value) {
        ...
        sprite.value.getWorldDirection(meshDirection);
    ...
    return (_ctx, _cache) => {
      return _openBlock$1(), _createElementBlock("TresMesh", {
        ...
        _cache[0] || (_cache[0] = _createElementVNode("TresPlaneGeometry", { args: [2, 2] }, null, -1)),
        _createElementVNode("TresShaderMaterial", _normalizeProps(_guardReactiveProps(tsMaterialConfig)), null, 16)
      ], 512);
    };
  }
});
...
//# sourceMappingURL=fireE.Dn84fpkv1767105581793.js.map

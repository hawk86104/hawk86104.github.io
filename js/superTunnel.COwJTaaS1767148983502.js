import{importShared as e}from"./3d-tiles-renderer.DZNovkLO1767148983502.js";const c=`varying vec2 vUv;
void main(){
	vUv=uv;
...
}`,{defineComponent:v}=await e("vue"),{createElementVNode:n,normalizeProps:i,guardReactiveProps:d,resolveComponent:l,mergeProps:m,withCtx:f,openBlock:x,createBlock:u}=await e("vue"),y={ref:"perspectiveCameraRef",position:[0,0,1800],fov:45,near:1,far:1e4},g=["rotation-x"],{AdditiveBlending:h,DoubleSide:z}=await e("three"),C=v({__name:"superTunnel",setup(b){const r={clearColor:"#000000",shadows:!0,alpha:!1,useLegacyLights:!0},o={uniforms:{uTime:{type:"f",value:0}},vertexShader:c,fragmentShader:p,side:z,blending:h,depthWrite:!1,transparent:!0},a=function(){o.uniforms.uTime.value+=.006};return(k,t)=>{const s=l("TresCanvas");return x(),u(s,m(r,{"window-size":"",onLoop:a}),{default:f(()=>[n("TresPerspectiveCamera",y,null,512),t[1]||(t[1]=n("TresAmbientLight",{color:"#ffffff"},null,-1)),t[2]||(t[2]=n("TresDirectionalLight",{position:[100,100,0],intensity:.5,color:"#ffffff"},null,-1)),n("TresMesh",{ref:"quanMeshRef","rotation-x":Math.PI},[t[0]||(t[0]=n("TresPlaneGeometry",{args:[4e3,4e3]},null,-1)),n("TresShaderMaterial",i(d(o)),null,16)],8,g)]),_:1},16)}}});export{C as default};

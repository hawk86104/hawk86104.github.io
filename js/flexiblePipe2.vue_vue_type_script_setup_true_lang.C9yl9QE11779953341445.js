import{importShared as r}from"./3d-tiles-renderer.RHiUBIoR1779953341445.js";import{useLoop as w,customShaderMaterial_default as T}from"./index.CE3jTVX71779953341445.js";import{buildRoundedPath as U}from"./buildFlexiblePipe.BWAN3-qG1779953341445.js";const{defineComponent:R}=await r("vue"),{createElementVNode:b,unref:G,createVNode:E,openBlock:L,createElementBlock:P}=await r("vue"),D={renderOrder:9999},B=["args"],{watch:f,ref:k}=await r("vue"),a=await r("three"),A=`
	varying vec2 vUv;
	void main() {
		vUv = vec3( uv, 1 ).xy; 
	}

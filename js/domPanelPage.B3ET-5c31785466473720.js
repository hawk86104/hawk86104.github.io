import{importShared as d}from"./3d-tiles-renderer.UsIBZbn81785466473720.js";import{OrbitControls_default as g}from"./index.BfLRicgG1785466473720.js";import{Pane as w}from"./tweakpane.BQRZXf8M1785466473720.js";import{_sfc_main as b}from"./domPanel.vue_vue_type_style_index_0_lang.DA5un0vj1785466473720.js";import{NModal as C}from"./Modal.Dm5YKs3t1785466473720.js";import{NInput as k}from"./Input.C_zTDw3q1785466473720.js";import{Button as m}from"./Button.NFlpJVkJ1785466473720.js";const{defineComponent:_}=await d("vue"),{createElementVNode:a,unref:r,createVNode:o,normalizeProps:h,guardReactiveProps:y,resolveComponent:B,withCtx:i,createTextVNode:u,Fragment:T,openBlock:N,createElementBlock:z}=await d("vue"),P={position:[1,2,3]},{reactive:M,ref:f}=await d("vue"),I=_({__name:"domPanelPage",setup(V){const t=M({center:!1,transform:!0,sprite:!1,distanceFactor:3,domContent:`

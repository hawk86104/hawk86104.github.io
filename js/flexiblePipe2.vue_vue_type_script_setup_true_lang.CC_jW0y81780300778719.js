import{importShared as r}from"./3d-tiles-renderer.ClFMxqO71780300778719.js";import{useLoop as w,customShaderMaterial_default as T}from"./index.EnH0mQcm1780300778719.js";import{buildRoundedPath as U}from"./buildFlexiblePipe.NQKs9RQa1780300778719.js";const{defineComponent:R}=await r("vue"),{createElementVNode:b,unref:G,createVNode:E,openBlock:L,createElementBlock:P}=await r("vue"),D={renderOrder:9999},B=["args"],{watch:f,ref:k}=await r("vue"),a=await r("three"),A=`
	varying vec2 vUv;
	void main() {
		vUv = vec3( uv, 1 ).xy; 
	}

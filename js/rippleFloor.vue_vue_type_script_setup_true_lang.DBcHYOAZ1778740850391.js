import{importShared as t}from"./3d-tiles-renderer.SzstPcaT1778740850391.js";import{useLoop as s,customShaderMaterial_default as c}from"./index.CVd4Rgkn1778740850391.js";const{defineComponent:v}=await t("vue"),{createElementVNode:u,unref:m,createVNode:y,openBlock:h,createElementBlock:g}=await t("vue"),p=["rotation-x"],{onMounted:C,watch:L,reactive:S}=await t("vue"),l=await t("three"),z=`
    varying vec2 vUv;
    void main() {
        vUv = uv;

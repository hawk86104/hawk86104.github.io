import{importShared as M}from"./3d-tiles-renderer.klHMwsjv1776738234056.js";import{derived as B,cB as x,cM as y,c as l,cE as a,createInjectionKey as D,useConfig as j,useTheme as R,useThemeClass as k,resolveWrappedSlot as K,resolveSlot as W,call as z}from"./light.6mrUGS4J1776738234056.js";import{formatLength as u}from"./format-length.BHvmju661776738234056.js";import{NBaseIcon as J,ErrorIcon as Q}from"./Close.Ch24F6Ng1776738234056.js";import{useMergedState as X,on as Y,off as Z}from"./use-merged-state.aLNpVtwP1776738234056.js";function oo(o){const{popoverColor:e,dividerColor:r,borderRadius:s}=o;return{color:e,buttonBorderColor:r,borderRadiusSquare:s,boxShadow:"0 2px 8px 0px rgba(0, 0, 0, .12)"}}const eo={common:B,self:oo},to=x("float-button-group",[x("float-button",`
 position: relative;
 `),y("square-shape",`

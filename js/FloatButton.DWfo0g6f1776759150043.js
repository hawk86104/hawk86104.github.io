import{importShared as M}from"./3d-tiles-renderer.DGvROtvg1776759150043.js";import{derived as B,cB as x,cM as y,c as l,cE as a,createInjectionKey as D,useConfig as j,useTheme as R,useThemeClass as k,resolveWrappedSlot as K,resolveSlot as W,call as z}from"./light.DKaGWYHJ1776759150043.js";import{formatLength as u}from"./format-length.BHvmju661776759150043.js";import{NBaseIcon as J,ErrorIcon as Q}from"./Close.UGpw_LWR1776759150043.js";import{useMergedState as X,on as Y,off as Z}from"./use-merged-state.BJDkJNTa1776759150043.js";function oo(o){const{popoverColor:e,dividerColor:r,borderRadius:s}=o;return{color:e,buttonBorderColor:r,borderRadiusSquare:s,boxShadow:"0 2px 8px 0px rgba(0, 0, 0, .12)"}}const eo={common:B,self:oo},to=x("float-button-group",[x("float-button",`
 position: relative;
 `),y("square-shape",`

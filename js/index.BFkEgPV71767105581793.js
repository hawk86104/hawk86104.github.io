	...
	},
	{
		...
		groupList: [
			...
			},
			{
				...
				option: {
					dataset: "line-md:uploading-loop",
					color: "#03A9F4",
					size: 64,
					rotate: 0
				}
...
const {createElementVNode:_createElementVNode,unref:_unref,createVNode:_createVNode,Suspense:_Suspense,withCtx:_withCtx,openBlock:_openBlock,createBlock:_createBlock,Fragment:_Fragment,createElementBlock:_createElementBlock} = await importShared('vue');
const _sfc_main = /* @__PURE__ */ _defineComponent({
  __name: "index",
  setup(__props) {
    return (_ctx, _cache) => {
      return _openBlock(), _createElementBlock(_Fragment, null, [
        _createVNode(_unref(ol), { "window-size": "" }, {
          default: _withCtx(() => [
            ...
            _createVNode(_unref(_sfc_main$1), { args: [3, 3] }),
        ...
        _createVNode(_unref(goViewCom), { dataJson: _unref(dataJson) }, null, 8, ["dataJson"])
      ], 64);
    };
  }
});
...
//# sourceMappingURL=index.BFkEgPV71767105581793.js.map

import{importShared as t}from"./3d-tiles-renderer.BeXgU1LO1781165239002.js";import{_sfc_main as d}from"./pagesShow.vue_vue_type_script_setup_true_lang.cT85HS5A1781165239002.js";import{useTres as m,useLoop as f}from"./index.CKaM2Yp11781165239002.js";const{defineComponent:p}=await t("vue"),{createElementVNode:a,normalizeProps:u,guardReactiveProps:h,openBlock:_,createElementBlock:P}=await t("vue"),{ref:x}=await t("vue"),o=await t("three"),y=`
varying vec2 vUv;
void main() {
vUv = uv;

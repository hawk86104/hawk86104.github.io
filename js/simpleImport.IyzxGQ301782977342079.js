...
`;let O=[];const se=(o,e,t,i)=>{const{uuid:r,...n}=t.object,a=JSON.parse(JSON.stringify(t));return a.object=n,`
<template>
    <loading />
...
<\/script>
`;o.file(`${e.fileName}`,r),O.push(e)},ce=()=>{let o="";return O.forEach(e=>{o+=`import ${e.comName} from './childComponent/${e.fileName}'
